...
class SandboxFusionConfig(BaseConfig):
    ...
    Args:
        ...
        pass_all (bool): When True, code reward is binary (1.0 only if every
            evaluated test case passes, else 0.0). When False, the score is the
            pass rate over evaluated cases.
    """
